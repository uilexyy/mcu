<template>
  <div>
    <PageHeader title="Riwayat Laboratorium">
      <template #actions>
    ...
    <BaseCard v-else-if="registrations.length === 0" no-padding>
      <EmptyState title="Belum ada riwayat" description="Belum ada hasil laboratorium yang tercatat." />
    </BaseCard>
...
async function fetchData() {
  ...
  try {
    ...
    const res = await api.get('/lab/riwayat', { params })
